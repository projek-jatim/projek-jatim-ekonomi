$(function () {
    ...
    initFilterSelect2('#periodeSelect', 'Pilih Periode');
    ...
    //     // extra safety: pastikan change meng-update chart
    //     $periode.on('change', function () {
    //         if (window.setGrowthPeriod) window.setGrowthPeriod(this.value);
    //     });
    // }
});
// (() => {
